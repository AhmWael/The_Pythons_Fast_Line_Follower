...
ROIS = [ # [ROI, weight]
        (20, 77, 120, 15, 0.7), # You'll need to tweak the weights for your app
        (20,  62, 120, 10, 0.3), # depending on how your robot is setup.
        (20,   32, 120, 25, 0.1)
       ]
...
#                first_exist=False
    ...
    img.draw_rectangle(20, 77, 120, 15, color = 0, thickness = 2, fill = False)
    img.draw_rectangle(20,  62, 120, 10, color = 0, thickness = 2, fill = False)
    img.draw_rectangle(20,   32, 120, 25, color = 0, thickness = 2, fill = False)
